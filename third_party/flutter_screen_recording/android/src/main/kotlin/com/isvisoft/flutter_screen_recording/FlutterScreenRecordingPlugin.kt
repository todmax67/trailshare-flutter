        ...
        when (call.method) {
            "startRecordScreen" -> {
                ...
                try {
                    ...
                    // FORK TrailShare (2026-07-04): su Android 14+ il dialog
                    // MediaProjection di default propone "Condividi un'app"
                    // (single-app capture) come prima scelta — con quel flusso
                    // la cattura parte sul picker e il video del fly 3D esce
                    // vuoto/sbagliato. Forziamo la sola opzione "schermo
                    // intero" con createConfigForDefaultDisplay().
